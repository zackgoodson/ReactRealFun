...
function Heading() {
  return (
    <h1>Welcome to MARCH MADNESSSSSSSSSS</h1>
  );
}


class Team extends React.Component<{school:string; name:string; abbrev:string; city:string; state:string}> {
  render() {
    ...
    return (
        <div>
          ...
          <h2>Name: {oneTeam.name}</h2>
          <h2>Abbrev: {oneTeam.abbrev}</h2>
